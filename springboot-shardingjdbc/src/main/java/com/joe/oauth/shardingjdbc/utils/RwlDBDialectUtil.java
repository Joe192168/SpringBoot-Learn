package com.joe.oauth.shardingjdbc.utils;
    ...
    public String getSqlLimit(String _sql, boolean hasOffset, int _start, int _limit) throws RwlDialectException {
        ...
        //IBM的DB2的分页方式 
            ...
            result.append("SELECT * FROM ( ")
                    ...
                    .append(_sql)
                    .append(" ) AS B ")
                    .append(" )AS A WHERE A.RN BETWEEN "+_start+" AND "+_limit+"");
            //结束
            if(log.isDebugEnabled()) { 
                log.debug(">>RwlDBDialect-end(db2):" + result);
            } 
            return result.toString();
        } 
